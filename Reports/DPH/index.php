...
<body>
<?php echo function_exists('prospeaking_mock_banner') ? prospeaking_mock_banner() : ''; ?>
...
<nav class="navbar navbar-default navbar-fixed-top" style='width:1024px;margin:0 auto'>
    <div class="container" style="text-align:center;">  
        ...
        <div style="left:10px; font-weight:bold; position:absolute; font-size:16px" id="leftHeader">DPH Report</div>
