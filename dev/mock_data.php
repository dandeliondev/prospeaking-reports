...
function prospeaking_mock_daily_rows(): array
{
    return [
        ...
        [
            'AGENT' => '4004', 'AGENT_NAME' => 'Sam Fronter', 'CAMPAIGN_ID' => 'UNVETPAC',
            'DEPTKEY' => 'CD', 'NUM_SALES' => 1, 'TOTAL_AMOUNT' => 45.0, 'FINAL_DISPOS' => 15,
            'TOTAL_HOURS' => 2.25, 'TOTAL_CALLS' => 55, 'XFERS' => 5, 'CCs' => 0, 'CC_AMT' => 0.0,
            'AGENT_TYPE' => 1, 'PARENT' => '4004', 'LIST_ID' => 1040, 'LIST_NAME' => 'Demo List D',
            'TYPE' => 'C', 'WRAP' => 1375, 'TALK' => 8250, 'WAIT' => 2200,
        ],
        [
            'AGENT' => '4005', 'AGENT_NAME' => 'Pat Closer', 'CAMPAIGN_ID' => 'CPFPAC',
            'DEPTKEY' => 'CD', 'NUM_SALES' => 4, 'TOTAL_AMOUNT' => 160.0, 'FINAL_DISPOS' => 50,
            'TOTAL_HOURS' => 5.5, 'TOTAL_CALLS' => 175, 'XFERS' => 18, 'CCs' => 1, 'CC_AMT' => 55.0,
            'AGENT_TYPE' => 1, 'PARENT' => '4005', 'LIST_ID' => 1041, 'LIST_NAME' => 'Demo List E',
            'TYPE' => 'C', 'WRAP' => 5500, 'TALK' => 33000, 'WAIT' => 8250,
        ],
    ];
}
